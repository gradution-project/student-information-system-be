...
public enum StudentLessonNoteMapping {
    ...
    MIDTERM_NOTE_STATE("MIDTERM_NOTE_STATE", "midtermNoteState"),
    FINAL_NOTE("FINAL_NOTE", "finalNote"),
    FINAL_NOTE_STATE("FINAL_NOTE_STATE", "finalNoteState"),
    RESIT_NOTE("RESIT_NOTE", "resitNote"),
    RESIT_NOTE_STATE("RESIT_NOTE_STATE", "resitNoteState"),
