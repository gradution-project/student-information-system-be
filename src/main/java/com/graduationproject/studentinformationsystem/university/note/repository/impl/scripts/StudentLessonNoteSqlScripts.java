...
public class StudentLessonNoteSqlScripts {
     ...
     * FROM STUDENT_LESSON_NOTE WHERE STUDENT_ID=:studentId
     * &&
     * ((FINAL_NOTE_STATE='CONFIRMED' && RESIT_NOTE_STATE='NOT_ENTERED' && STATUS='PASSED')
     * ||
     * (FINAL_NOTE_STATE='CONFIRMED' && RESIT_NOTE_STATE='CONFIRMED' && (STATUS='PASSED' || STATUS='FAILED')));
     */
    public static final String GET_STUDENT_LESSONS_ALL_CONFIRMED_NOTES_BY_STUDENT_ID =
            sqlBuilder.delete(0, sqlBuilder.length())
                    .append(GET_ALL_STUDENTS_LESSONS_NOTES)
                    .append("WHERE STUDENT_ID=:studentId ")
                    .append("&& ")
                    .append("((FINAL_NOTE_STATE='CONFIRMED' && RESIT_NOTE_STATE='NOT_ENTERED' && STATUS='PASSED') ")
                    .append("|| ")
                    .append("(FINAL_NOTE_STATE='CONFIRMED' && RESIT_NOTE_STATE='CONFIRMED' && (STATUS='PASSED' || STATUS='FAILED')))").toString();
