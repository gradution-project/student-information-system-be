...
public enum TeacherPersonalInfoMapping {
    ...
    public static final Map<String, String> COLUMN_MAPPINGS = Stream.of(values()).collect(Collectors.toMap(TeacherPersonalInfoMapping::getColumnName, TeacherPersonalInfoMapping::getModelName));
}
