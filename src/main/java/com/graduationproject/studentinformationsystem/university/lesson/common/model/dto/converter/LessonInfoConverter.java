...
public class LessonInfoConverter {
    ...
    public LessonEntity generateSaveEntity(final Long lessonId,
        ...
        return LessonEntity.builder()
                ...
                .theoreticalHours(lessonInfoRequest.getTheoreticalHours())
                .practiceHours(lessonInfoRequest.getPracticeHours())
    ...
    public LessonResponse entityToResponse(final LessonEntity lessonEntity) {
        ...
        return LessonResponse.builder()
                ...
                .theoreticalHours(lessonEntity.getTheoreticalHours())
                .practiceHours(lessonEntity.getPracticeHours())
